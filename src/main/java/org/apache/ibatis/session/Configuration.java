...
public class Configuration {
  ...
  /**
   * 返回执行器，如果开启缓存，默认为true,返回CachingExecutor-》 内部委派给BatchExecutor，ReuseExecutor，SimpleExecutor 其中一种，一般为默认SimpleExecutor
   *
   * @param transaction
   * @param executorType
   * @return
